...
// For Server Components: use `createServerClient` or `createStaticClient` from '@/lib/supabase/server'

// Re-export client-side supabase instance
export { supabase } from './supabase/client';

// Re-export server-side functions
export { createServerClient, createStaticClient } from './supabase/server';